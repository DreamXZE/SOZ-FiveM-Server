...
QBShared.Items = {
    ...
    ['neutalized_weapon_bag'] = {
        ['name'] = 'neutalized_weapon_bag',
        ['label'] = "Sac d'armes neutralisées",
        ['weight'] = 2000,
        ['type'] = 'item_illegal',
        ['unique'] = false,
        ['useable'] = false,
        ['shouldClose'] = true,
        ['combinable'] = nil,
        ['description'] = "Un sac robuste renfermant des armes, une rareté dans le monde clandestin.",
        ['illustrator'] = '.Sniteur'
    },
    ['rare_jewelbag_illegal'] = {
        ['name'] = 'rare_jewelbag_illegal',
        ['label'] = 'Sac de bijoux rare',
        ['weight'] = 2500,
        ['type'] = 'item_illegal',
        ['unique'] = false,
        ['useable'] = false,
        ['shouldClose'] = true,
        ['combinable'] = nil,
        ['description'] = "Un sac élégant renfermant une sélection exquise de bijoux rares, c'est de toute beauté.",
        ['illustrator'] = '.Sniteur'
    },
    ['rare_small_moneybag_illegal'] = {
        ['name'] = 'rare_small_moneybag_illegal',
        ['label'] = 'Petit sac d\'argent rare',
        ['weight'] = 1000,
        ['type'] = 'item_illegal',
        ['unique'] = false,
        ['useable'] = false,
        ['shouldClose'] = true,
        ['combinable'] = nil,
        ['description'] = 'Un petit sac en bronze, contenant une richesse rare et convoitée.',
        ['illustrator'] = '.Sniteur'
    },
    ['rare_medium_moneybag_illegal'] = {
        ['name'] = 'rare_medium_moneybag_illegal',
        ['label'] = 'Moyen sac d’argent rare',
        ['weight'] = 1500,
        ['type'] = 'item_illegal',
        ['unique'] = false,
        ['useable'] = false,
        ['shouldClose'] = true,
        ['combinable'] = nil,
        ['description'] = "Un magnifique sac en argent, débordant d'exquises richesses.",
        ['illustrator'] = '.Sniteur'
    },
    ['rare_big_moneybag_illegal'] = {
        ['name'] = 'rare_big_moneybag_illegal',
        ['label'] = 'Grand sac d\'argent rare',
        ['weight'] = 2000,
        ['type'] = 'item_illegal',
        ['unique'] = false,
        ['useable'] = false,
        ['shouldClose'] = true,
        ['combinable'] = nil,
        ['description'] = "Un sac EN OR, il vous assure Fortune, Gloire et Pouvoir !",
        ['illustrator'] = '.Sniteur'
    },
    ['police_pliers'] = {
        ['name'] = 'police_pliers',
    ...
    ['lemon_cheesecake'] = {
        ['name'] = 'lemon_cheesecake',
        ['label'] = "Cheesecake au citron",
        ['weight'] = 600,
        ['useable'] = true,
        ['type'] = 'food',
        ['nutrition'] = {
        ...
        ['durability'] = 14,
        ['description'] = "Un délicieux petit cheesecake au citron pour émerveiller vos papilles.",
        ['illustrator'] = '.Moustash',
    },
    ['country_feast'] = {
        ['name'] = 'country_feast',
    ...
    ['halloween_rod'] = {
        ...
        ['unique'] = true,
        ['combinable'] = nil,
        ['description'] = "T'es encore là ? Va pêcher tes grands mort on t'as dis.",
        ['illustrator'] = '.Aurukh'
    },
    ['prestige_rod'] = {
        ['name'] = 'prestige_rod',
    ...
    ['halloween_devil_bait'] = {
        ...
        ['unique'] = false,
        ['combinable'] = nil,
        ['description'] = "Un appat fais de chair inconnue façonné pour attirer les monstres marins et créatures inconnues.",
        ['illustrator'] = '.Crash'
    },
    ['sozedex'] = {
        ['name'] = 'sozedex',
    ...
    ['badge_halloween'] = {
        ['name'] = 'badge_halloween',
        ['label'] = "Badge \"Halloween\"",
        ['useable'] = false,
        ['weight'] = 2000,
        ['type'] = 'item',
        ['description'] = "Prestige reçu à l'occasion de la complétion du Sozédex d'Halloween.",
        ['illustrator'] = '.Poulpito',
    },
    --- FISHES ---
    ...
    ['carpe_feur'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Cette carpe était à l'origine une simple carpe koi. Malheureusement, à force d'entendre les pêcheur s'envoyer des \"J'ai une carpe koi ! \" \"Feur !\". Son nom changea en Carpe Feur, pour contrer cette habitude des pêcheurs.",
        ['illustrator'] = ".Holowbsl",
        ['fishing_area'] = {'big_lake','river'},
     ...
     ['carpe_a_jouer'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Elle tient son nom de sa forme faite de Cartes de jeux classiques. Son apparence vient du fait qu'elle vie dans les petites étendues d'eaux proche des salles de jeux, casino et bars. À force de voir des cartes jetées dans son habitat, la Carpe s'est servi de ces \"déchets\" pour protéger ses écailles.",
        ['illustrator'] = ".Holowbsl",
        ['fishing_area'] = {'little_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'night','evening'},
     ...
     ['homard_indigo_saxicole'] = {
        ['name'] = "homard_indigo_saxicole",
        ['label'] = "Homard indigo saxicole",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le homard indigo saxicole est une espèce de homard qui, comme son nom l'indique, vit exclusivement dans les courants d'eaux avec une forte présence de roches et de pierres. Sa carapace est poreuse, ce qui en fait son moyen s’oxygéner. Cependant, elle est plus fragile que d'autres homards, c'est pourquoi les individus de cette espèce ont besoin de se protéger de ses prédateurs en se camouflant sous des pierres. Son prédateur naturel est la Sandre Florale.",
        ['illustrator'] = ".Poulpitor",
        ['fishing_area'] = {'river'},
        ['fishing_weather'] = {'FOGGY','SMOG'},
        ['fishing_period'] = {'night'},
     ...
     ['flabellina'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Les flabellina sont des nudibranches minuscules avec de très jolies couleurs. La population est composé à 80% d'individus de sexe féminin. Elles se nourrissent d'algues. Lorsque vient la période de reproduction on peut les voir danser un flamenco sur le haut des rochers en attente d'un partenaire.",
        ['illustrator'] = ".Jake Freaks",
        ['fishing_area'] = {'littoral','south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'morning','afternoon'},
        ['fishman_status'] = 'clean',
     ...
     ['comtecombre_de_mer'] = {
        ['name'] = "comtecombre_de_mer",
        ['label'] = "Comtecombre de mer",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Un concombre de mer ou \"holothurie\" de couleur jaune. Il filtre l'eau marine et ne garde que la nourriture la plus exquise. Il supporte mal la présence de poissons moins nobles que lui et crache des morceaux de ses tripes sur eux pour les éloigner. Ses tripes se régénèrent en quelques minutes.",
        ['illustrator'] = ".Jake Freaks",
        ['fishing_area'] = {'littoral','south_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
     ...
     ['noctiscale'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Ce serpent aquatique se cache dans les algues de rivières ou de lacs à l'affût de ses proies. Lorsque vient la nuit, il luit, indiquant sa présence dans le fourré d'algues à ses congénères et perturbant l'orientation des poissons nocturnes autour de lui.",
        ['illustrator'] = ".Jake Freaks",
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'FOGGY','SMOG','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'night','evening'},
     ...
     ['luninja'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le Luninja est un petit poisson élégant au corps argenté et avec des nageoires en forme de croissants de lune. Il peut absorber la lumière de la lune pour devenir invisible la nuit et se déplacer furtivement pour s'échapper des prédateurs. De jour il se repose caché parmi les Sunny avec qui il vit en symbiose.",
        ['illustrator'] = ".Ruruissime",
        ['fishing_area'] = {'littoral','south_sea'},
        ['fishing_weather'] = {'RAIN','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'night','evening'},
        ['fishman_status'] = 'clean',
     ...
     ['saumon'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Quoi ? T'as jamais vu de saumon ?",
        ['illustrator'] = ".Neochrom",
        ['fishing_area'] = {'north_sea','river'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'morning','evening'},
        ['fishman_status'] = 'clean',
        ['min_weight'] = 3000,
     ...
     ['pleutrisson'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Petit poisson très craintif rasant le sable, il reste proche des bords de mer par peur des fonds marins et à une certaine distance des plages par trouille de s'y échouer. Paranoïaque, il se méfie de toute autre espèce vivante, minérale ou végétale. Il a également peur du noir et ne se montre qu'en journée. Sa principale cause de décès reste malgré tout la crise cardiaque..",
        ['illustrator'] = ".Kloz",
        ['fishing_area'] = {'littoral'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'morning','afternoon'},
     ...
     ['mousseton'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "C'est une petite algue marine très joueuse, surtout quand il s'agit de faire du saute-mousseton avec les poissons. On peut la rencontrer entourée de ses camarades de jeu, dans les rochers et les cailloux où elle se cache",
        ['illustrator'] = ".Dr_Paalmipedus",
        ['fishing_area'] = {'river'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'afternoon'},
        ['fishman_status'] = 'clean',
     ...
     ['cocqueluchard_a_crete_rouge'] = {
        ['name'] = "cocqueluchard_a_crete_rouge",
        ['label'] = "Cocqueluchard à crête rouge",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "La taille de la longue crête rouge arborée par ce poisson augmente avec son âge. Chez les plus vieux spécimens, elle peut atteindre le double de leur corps.",
        ['illustrator'] = ".Smogogo",
        ['fishing_area'] = {'north_sea','south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'afternoon','evening'},
     ...
     ['bar_a_thym'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Attention, avec ses écailles en forme de plante condimentaire Provençale, le bar à thym vous raconte des salades !",
        ['illustrator'] = ".Berson",
        ['fishing_area'] = {'big_lake','little_lake','river','canals'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'afternoon', 'morning'},
        ['fishman_status'] = 'clean',
        ['min_weight'] = 500,
        ['max_weight'] = 2600,
        ['min_length'] = 20,
     ...
     ['carassin_tropical'] = {
        ['name'] = "carassin_tropical",
        ['label'] = "Carassin tropical",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Victime d'une mode sur les réseaux sociaux consistants à se prendre en photo en faisant mine de lécher un Carassin, l'animal est désormais protégé sur une partie du territoire Américain.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'south_sea'},
        ['fishing_weather'] = {'RAIN','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'night','evening'},
     ...
     ['demoiselle_maraichere'] = {
        ['name'] = "demoiselle_maraichere",
        ['label'] = "Demoiselle maraichère",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Ce poisson est capable de se déplacer sur un sol boueux et humide sur quelques dizaines de mètres pour aller chercher sa nourriture.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'FOGGY','SMOG','RAIN'},
        ['fishing_period'] = {'morning','afternoon','evening'},
        ['fishman_status'] = 'clean',
        ['min_weight'] = 250,
        ['max_weight'] = 450,
        ['min_length'] = 12,
     ...
     ['kokoro_spumeux'] = {
        ['name'] = "kokoro_spumeux",
        ['label'] = "Kokoro spumeux",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Apparemment c'est la mascotte d'un manga populaire au Japon. Il y a un son propre spin-off animé avec plusieurs des OAV, des figurines en PVC et des dakimakura.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'south_sea'},
        ['fishing_weather'] = {'FOGGY','SMOG','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'drug',
        ['min_weight'] = 1100,
        ['max_weight'] = 1500,
     ...
     ['origafish'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Pour consommer le poisson, pliez la feuille F57 en angle droit sur la nageoire dorsale et enfin tirez sur la languette D41 que vous avez laissé à l'étape 103. Et voilà ! Servir avec un filet de jus de citron.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'littoral','canals'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'morning'},
     ...
     ['zeta_membraneux'] = {
        ['name'] = "zeta_membraneux",
        ['label'] = "Zêta membraneux",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Il parait que c'est avec ça qu'on fait les meilleurs écrans vert pour le cinéma.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'littoral','south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'night','evening'},
        ['fishman_status'] = 'alcool',
        ['min_weight'] = 1497,
        ['max_weight'] = 2023,
     ...
     ['dragon_des_mers'] = {
        ['name'] = "dragon_des_mers",
        ['label'] = "Dragon des Mers",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Il est appelé trivialement « dragon des mers » en raison de son apparence générale, les individus de cette espèce ont la capacité d'intégrer les chloroplastes des algues dont elle se nourrit et de les utiliser pour faire de la photosynthèse. Juste trop fort enfaite !",
        ['illustrator'] = ".Dar4k",
        ['fishing_area'] = {'littoral','south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'alltime'},
     ...
     ['mi-octo_grandmax'] = {
        ['name'] = "mi-octo_grandmax",
        ['label'] = "Mi-Octo GrandMax",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Provenant des tréfonds marins, son apparence entre le poulpe et la nautile, ainsi que la différence dans la longueur de ses tentacules lui ont valu son nom Mi-Octo GrandMax. En état d'hibernation la plupart de l'année, le Mi-Octo GrandMax devient actif entre mi-août et mi-octobre pour la reproduction et pour faire ses réserves de nourriture. Tout au long de l'année, seuls les blizzards en surface peuvent le sortir de l'hibernation. Les individus s'organisent en communauté pour chasser des proies coriaces bien plus grandes qu'un individu seul, on parle alors de raids. Un groupe de ces individus est appelé une guilde.",
        ['illustrator'] = ".Pandou",
        ['fishing_area'] = {'north_sea'},
        ['fishing_weather'] = {'SNOW','SNOWLIGHT','XMAS','BLIZZARD','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',
        ['min_weight'] = 1408,
        ['max_weight'] = 1510,
     ...
     ['crobrail'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Il est dit que Crobrail est une fusion fascinante entre une méduse et un crabe. Son corps pratiquement translucide lui permet de se camoufler dans les les coraux, opportuniste il se nourris de petits poissons ou de reste de sandwich abandonnés par les touristes. Attention ses pinces sont particulièrement urticantes, pensez à le manipuler avec des gants! ",
        ['illustrator'] = ".Ruruissime",
        ['fishing_area'] = {'littoral','north_sea','south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'alltime'},
     ...
     ['draquaticus'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le Draquaticus ressemble à un petit dragon marin. La légende raconte qu'à force d’être chassés dans les airs, certains dragons partirent se réfugier sous l'eau, le Draquaticus en serait un lointain cousin. Très curieux et joueur, il aime s'amuser avec les plongeurs et ses congénères. Sa crinière d'algue lui servent pour ressentir les vibrations dans l'eau et pour se cacher dans les algues en cas de danger. ",
        ['illustrator'] = ".Ruruissime",
        ['fishing_area'] = {'big_lake','river'},
        ['fishing_weather'] = {'FOGGY','SMOG','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'morning','afternoon'},
     ...
     ['abherus_le_dentu'] = {
        ['name'] = "abherus_le_dentu",
        ['label'] = "Abherus le dentu",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "La terreur des pêcheurs, nombreux sont ceux qui ont perdu une main en voulant attraper ce poisson. Tuant les autres poissons par plaisir, il est très important de réguler la présence de cette espèce.",
        ['illustrator'] = ".Adrass",
        ['fishing_area'] = {'littoral','river'},
        ['fishing_weather'] = {'RAIN','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'night','evening'},
        ['fishman_status'] = 'clean',
        ['min_weight'] = 620,
        ['max_weight'] = 2600,
     ...
     ['mur_haine'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Ce croisement entre une murène et un crocodile marin n'est pas commode, bien que inoffensif envers les hommes, il se nourrit de nombreux petits poissons tels que les exocets.",
        ['illustrator'] = ".Adrass",
        ['fishing_area'] = {'north_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','SNOW','SNOWLIGHT','XMAS','BLIZZARD'},
        ['fishing_period'] = {'alltime'},
     ...
     ['tyrannus_piscis'] = {
        ['name'] = "tyrannus_piscis",
        ['label'] = "Tyrannus Piscis",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Malgré sa petite taille, ce poisson est surnommé le \"Tyran des mers\" et attaque à vue tout chose qui viendrait le déranger, surtout pendant son repas. De très sérieuses recherches ont montré que l'alcool le rendrait plus joyeux et qu'il serait capable de produire des sons ressemblant à une femme chantant une douce mélodie.",
        ['illustrator'] = ".Zedhekya",
        ['fishing_area'] = {'north_sea','south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'night','afternoon','evening'},
        ['fishman_status'] = 'alcool',
        ['min_weight'] = 30,
        ['max_weight'] = 90,
        ['min_length'] = 10,
     ...
     ['grincheux_cramoisi'] = {
        ['name'] = "grincheux_cramoisi",
        ['label'] = "Grincheux Cramoisi",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Une espèce de requin peu commune dont la peau est rouge comme le sang. Ils sont plutôt agressifs de nature, mais leur régime alimentaire est principalement fait de crustacés et de petits poissons.",
        ['illustrator'] = ".Zedhekya",
        ['fishing_area'] = {'littoral','south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','RAIN'},
        ['fishing_period'] = {'morning','afternoon'},
     ...
     ['blogogloblo'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Un pêcheur emmena son jeune fils à la pêche, malheureusement, pas un poisson à l'horizon, jusqu'à ce que cette chose se montre. Le pêcheur n'avait pas les mots pour décrire ce qu'il voyait, son fils par contre, a trouvé un nom qui lui convient, enfin peut-être.",
        ['illustrator'] = ".Zedhekya",
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'FOGGY','SMOG','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'morning'},
     ...
     ['fishy_duck'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Il existe bien des ornithorynques, pourquoi pas des Fishy Duck ? C'est la réflexion d'un expert en faune maritime et amateur de vieux cartoons quand il a vu cette chose.",
        ['illustrator'] = ".Zedhekya",
     ...
     ['la_sardynamite'] = {
        ['name'] = "la_sardynamite",
        ['label'] = "La Sardynamite",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Attention, ne l'énervez pas, sinon elle vous pète a la gueule. La légende raconte que personne n'a jamais pu en observer ... ou alors ils étaient juste eux aussi, trop explosés pour s'en souvenir ...",
        ['illustrator'] = ".Rocno",
        ['fishing_area'] = {'north_sea','south_sea'},
        ['fishing_weather'] = {'FOGGY','SMOG','RAIN'},
        ['fishing_period'] = {'night'},
     ...
     ['fluroralia_nocturne'] = {
        ['name'] = "fluroralia_nocturne",
        ['label'] = "Fluroralia nocturne",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Cette anémone de mer emmagasine les rayons du soleil pendant la journée et les absorbe pour les restituer sous forme de lumière fluorescente la nuit.",
        ['illustrator'] = ".Smogogo",
        ['fishing_area'] = {'north_sea','south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'night','evening'},
     ...
     ['petit_poulpe_royal'] = {
        ['name'] = "petit_poulpe_royal",
        ['label'] = "Petit poulpe royal",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le petit poulpe royal est une espèce de poulpe à cornes qui ressemble à une couronne. Ses cornes sont très souples et permet à certains organismes minuscules de s'abriter. Malgré cette couronne, le petit poulpe royal reste à une taille très petite toute sa vie, ce qui le rend vulnérable et souvent prisé par les prédateurs.",
        ['illustrator'] = ".Poulpitor",
        ['fishing_area'] = {'littoral','river'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','RAIN'},
        ['fishing_period'] = {'alltime'},
     ...
     ['tortue_imperiale'] = {
        ['name'] = "tortue_imperiale",
        ['label'] = "Tortue impériale",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Les premières personnes à avoir observé ses spécimens l'ont nommé comme pour plusieurs raisons : sa peau bleutée, ses tâches rouge-vif, sa carapace aux reflets dorées et son regard condescendant. Ces quatre éléments lui ont valu le nom \"Impériale\". Les épines qui lui servent de couronne sont acérées et dangereuses, c'est un moyen de défense redoutable. La tortue impériale n'hésitera pas à se défendre même s'il faut embrocher d'autres individus.",
        ['illustrator'] = ".Poulpitor",
        ['fishing_area'] = {'north_sea'},
        ['fishing_weather'] = {'FOGGY','SMOG','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'morning'},
     ...
     ['tort_aily'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Vème du nom de sa lignée, c'est une torture de mer à durée de vie très longue. Elle adore vivre en communauté des autres animaux marins et sa carapace en forme de cœur la protège des attaques des prédateurs. Très gentille et disponible, elle reste tout de même indépendante et vous pourrez toujours compter sur elle si vous savez l'apprivoiser",
        ['illustrator'] = ".Dr_Paalmipedus",
        ['fishing_area'] = {'littoral','south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'alltime'},
     ...
     ['draceen'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Dracéen est une légende parmi les habitants de l'océan, et on disait qu'il possède des pouvoirs magiques. Il peut contrôler les courants marins et créer des tempêtes sous-marines à l'aide de ses nageoires puissantes et de ses griffes étincelantes. Pourtant, malgré sa puissance, Dracéen est une créature pacifique. Il vit dans un vaste récif corallien au fond de l'océan, où il protégeait les autres créatures marines des prédateurs en utilisant ses capacités magiques pour créer des barrières d'eau impénétrables.",
        ['illustrator'] = ".Nooby",
        ['fishing_area'] = {'south_sea'},
        ['fishing_weather'] = {'RAIN','OVERCAST','CLOUDS','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'afternoon'},
        ['fishman_status'] = 'clean',
        ['min_weight'] = 3000,
        ['max_weight'] = 5000,
     ...
     ['tribow'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Dans les profondeurs paisibles de l'océan, un petit escargot des mers nommé Tribow. Il était différent des autres escargots des mers, car sa coquille était d'une beauté extraordinaire. Elle arborait les couleurs de l'arc-en-ciel, allant du rouge vif au violet profond, créant une coquille scintillante qui éblouissait tous ceux qui la voyaient et ses trois antennes délicates sur sa tête. Ces antennes lui permettaient de détecter les courants marins et de communiquer avec les autres créatures de l'océan en émettant des signaux lumineux colorés.",
        ['illustrator'] = ".Nooby",
        ['fishing_area'] = {'littoral','north_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','RAIN','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'afternoon'},
        ['fishman_status'] = 'alcool',
        ['min_weight'] = 10,
        ['max_weight'] = 40,
     ...
     ['angryd_o'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le Angryd'o est toujours un poisson mâle. Il s'épanouit dans les eaux chaudes et tempétueuses, toujours en quête de beaux coquillages et de courants chauds. Il a toujours l'air de mauvaise humeur et aime nager seul pour trouver des proies à manger. Côté amour son cœur est très fidèle, l'Angryd'o recherchera toujours son âme sœur parmi les Happyd'o de mer du nord. On dit que le seul moment où il peut se reproduire est en hiver, lorsque les intempéries de cette saison permettent aux deux espèces de se retrouver.",
        ['illustrator'] = ".Zupcurl",
        ['fishing_area'] = {'south_sea'},
        ['fishing_weather'] = {'SNOW','SNOWLIGHT','XMAS','BLIZZARD','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'night'},
     ...
     ['petit_dragon_des_mers'] = {
        ['name'] = "petit_dragon_des_mers",
        ['label'] = "Petit dragon des mers",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Ce poisson doit son nom à ses grosses écailles, ses deux nageoires dorsales qui ressemblent à des ailes et sa couleur orangée. Il possède également deux petites nageoires qui ressemblent à ses pattes mais dont il se sert pour se propulser en prenant appui sur le sol ou sur des rochers. Malgré son nom, il est inoffensif. ",
        ['illustrator'] = ".Poulpitor",
        ['fishing_area'] = {'south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'morning','afternoon'},
     ...
     ['langostazul'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Cette teinte bleue exceptionnelle, est due à une anomalie génétique qui favorise le développement d’un excès de crustacyanine, le pigment bleu. Vivant dans les eaux des caraïbes et notamment au Mexique, cette espèces se cache la journée et sort la nuit pour chasser. On la retrouve surtout sur les côtes de Cayo Perico.",
        ['illustrator'] = ".Davixini",
        ['fishing_area'] = {'south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'night'},
        ['fishman_status'] = 'clean',
     ...
     ['happyd_o'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le Happyd'o est toujours un poisson femelle. Elle s'épanouit dans les climats nordique mais ensoleillés, toujours en quête de beaux coraux et d'eau bien fraîche. Elle est toujours joyeuse, et aime rendre service aux autres poissons en leur apportant de la nourriture. Côté amour son cœur est très fidèle, l'Happyd'o recherchera toujours son âme sœur parmi les Angryd'o de mer du sud. On dit que le seul moment où elle peut se reproduire est en hiver, lorsque les intempéries de cette saison permettent aux deux espèces de se retrouver. ",
        ['illustrator'] = ".Examy",
        ['fishing_area'] = {'north_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','SNOW','SNOWLIGHT','XMAS','BLIZZARD'},
        ['fishing_period'] = {'morning'},
     ...
     ['le_pasne'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le Pasné se camoufle au fond des eaux troubles et peu profondes grâce à son dos recouvert d'une peau se fondant dans la mousse et les algues. Cette force est récemment devenue sa plus grande faiblesse lorsqu'un industriel local à découvert qu'il tenait là un poisson pouvant remplacer pour pas cher les poissons surgelés du supermarché. Conseils de préparation: 10 minutes à la poêle ou la friteuse, servir avec du ketchup.",
        ['illustrator'] = ".Danacol",
        ['fishing_area'] = {'little_lake','canals'},
        ['fishing_weather'] = {'FOGGY','SMOG','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'afternoon'},
     ...
     ['chelonienseparables'] = {
        ['name'] = "chelonienseparables",
        ['label'] = "Chélonienséparables",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Ces deux types de chéloniens passent tellement de temps ensemble qu'au bout d'un certains temps, des couples inséparables se forment. Leurs membres s'attachent ensemble et leurs carapaces aussi. Une fois que le couple s'est formé il est lié pour toujours, quand l'un des deux meurt l'autre aussi.",
        ['illustrator'] = ".Holowbsl",
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
     ...
     ['yuko'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le Yuko est une espèce que les scientifiques peinent à étudier : il a été établi que les jeunes mâles naissent en mer, puis remontent les rivières pour rejoindre les lacs du Mont Gordo lors des premières neiges. Là, lors d'une pleine lune, le jeune mâle entame sa danse nuptiale et fusionne avec une femelle pour former un poisson adulte à deux têtes appelé \"Yuko\". Dû à la très grande difficulté de capturer de jeunes spécimens, une grande partie de ce processus de reproduction reste toutefois un mystère pour les scientifiques. Un proverbe local dit que \"seul l'oeil aviné peut voir les Yukos danser sous les rochers\".",
        ['illustrator'] = ".HayaBusaEyes",
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','SNOW','SNOWLIGHT','XMAS','BLIZZARD'},
        ['fishing_period'] = {'night','evening'},
        ['fishman_status'] = 'alcool',
     ...
     ['reinette'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "A ne pas confondre avec la rainette, sa cousine européene, la Reinette de San Andreas peuple les rivières de l'île est est reconnaissable aux excroissances sur sa tête qui lui dessinent comme une couronne de feuilles. Attention toutefois, l'embrasser ne la transformera pas en prince ou princesse à marier, et en plus c'est dégueulasse !",
        ['illustrator'] = ".Danacol",
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'FOGGY','SMOG','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'evening'},
     ...
     ['arguyere_bicephale'] = {
        ['name'] = "arguyere_bicephale",
        ['label'] = "Arguyère bicéphale",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "L'une des deux extrémité est en réalité un cloaque qui a l'air d'être une tête pour effrayer ses potentiels prédateur. Mais attention aux dents tout de même.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'river','canals'},
        ['fishing_weather'] = {'FOGGY','SMOG','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'night','evening'},
     ...
     ['berger_de_floride'] = {
        ['name'] = "berger_de_floride",
        ['label'] = "Berger de Floride",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Ce poisson au mauvais caractère a pour habitude de pousser les bancs d'autres poissons à se regrouper.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'north_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'alltime'},
     ...
     ['elicie_californien'] = {
        ['name'] = "elicie_californien",
        ['label'] = "Elicie californien",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "L'Élicie se déplace en spirale pour désorienter ses prédateurs grâce à des tâches colorés sous sa peau. Si elle se sent menacée, elle peut émettre un flash lumineux.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'littoral','north_sea'},
        ['fishing_weather'] = {'RAIN','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'night','evening'},
     ...
     ['exocet_colibri'] = {
        ['name'] = "exocet_colibri",
        ['label'] = "Exocet colibri",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "L'exocet colibri est un des très rares pollinisateur du monde aquatique. Ses nageoires transformées en ailes battent si vite que le mouvement est imperceptible à l'œil nu.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'alltime'},
     ...
     ['exocet_oriental'] = {
        ['name'] = "exocet_oriental",
        ['label'] = "Exocet oriental",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "L'exocet oriental est une espèce invasive originaire d'Asie. Il est carnivore et utilise son museau pointu pour percer la peau d'autres poissons plus gros et se nourrir de leur sang. ",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'morning','afternoon'},
     ...
     ['exocet_sardine'] = {
        ['name'] = "exocet_sardine",
        ['label'] = "Exocet sardine",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "L'exocet sardine vit en bancs de plusieurs centaines d'individus. Elles sentent très mauvais comme leurs cousines couleur saphir, mais elles ont bien meilleurs goût !",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'north_sea','south_sea'},
        ['fishing_weather'] = {'RAIN','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'night','morning'},
     ...
     ['finette'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Une fois sortie de l'eau, la Finette  fait des petits miaulements. On ne sait pas vraiment pourquoi, mais ça serait presque mignon si elle était pas en train d'asphyxier.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'RAIN','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'alltime'},
     ...
     ['hampe-noire_albinos'] = {
        ['name'] = "hampe-noire_albinos",
        ['label'] = "Hampe-noire Albinos",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Les Hampe-noires vivent en colonies eusociales comme les fourmis et les termites. Ils dessinent des spirales sur le fond marin en déplaçant le sable avec leurs nageoires.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'north_sea'},
        ['fishing_weather'] = {'SNOW','SNOWLIGHT','XMAS','BLIZZARD','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'night'},
        ['fishman_status'] = 'alcool',
        ['min_weight'] = 1000,
        ['max_weight'] = 2023,
     ...
     ['iridesce_cyclope'] = {
        ['name'] = "iridesce_cyclope",
        ['label'] = "Iridèsce cyclope",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Ce poisson a un cycle de vie similaire aux grenouilles avec une forme en têtard. Il ne se métamorphose en forme adulte qu'une fois tous les dix ans pour se reproduire. Sa population est fortement réduite et il pourrait disparaitre avant la fin du siècle.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'littoral'},
        ['fishing_weather'] = {'FOGGY','SMOG','RAIN'},
        ['fishing_period'] = {'night','evening'},
     ...
     ['jolicoeur_smaragdin'] = {
        ['name'] = "jolicoeur_smaragdin",
        ['label'] = "Jolicoeur smaragdin",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Originaire de l'Océan Indien, ce truc n'a probablement rien à faire là.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'big_lake','river'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','SNOW','SNOWLIGHT','XMAS','BLIZZARD'},
        ['fishing_period'] = {'morning','afternoon'},
     ...
     ['mouchi_papillon'] = {
        ['name'] = "mouchi_papillon",
        ['label'] = "Mouchi papillon",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Cousin lointain du poisson-volant, cet animal a depuis longtemps perdu sa capacité à sauter et planer au dessus des vagues. Mais il est très joli !",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'morning','afternoon'},
     ...
     ['perche_leopard'] = {
        ['name'] = "perche_leopard",
        ['label'] = "Perche léopard",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "La grande marque de mode Sessanta Nove a essayé d'en faire des sacs à mains et des chaussures à une époque. Ça n'a pas bien pris.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'big_lake'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','SNOW','SNOWLIGHT','XMAS','BLIZZARD'},
        ['fishing_period'] = {'alltime'},
     ...
     ['qazoar_antique'] = {
        ['name'] = "qazoar_antique",
        ['label'] = "Qazoar antique",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Ce petit machin aux yeux d'ébène se déplace en faisant \"plop plop\". Lorsqu'on le tien dans la paume de sa main, une envie irrépressible de serrer le poing emporte environ 86% de la population.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'river'},
        ['fishing_weather'] = {'FOGGY','SMOG','RAIN'},
        ['fishing_period'] = {'alltime'},
     ...
     ['rondouille_gibeuse'] = {
        ['name'] = "rondouille_gibeuse",
        ['label'] = "Rondouille gibeuse",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "La Rondouille gibeuse est exclusivement nocturne. Elle nait, vit, se reproduit et meurt dans la vase. Il vous semble que son regard s'est illuminé d'émerveillement en sortant de l'eau pour découvrir que le monde était bien plus grand, plus lumineux et plus coloré qu'elle ne le pensait jusqu'à présent.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'canals'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'night'},
     ...
     ['saumon_d_andreas'] = {
        ['name'] = "saumon_d_andreas",
        ['label'] = "Saumon d'Andreas",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Il remonte la rivière pour se reproduire en eau douce au cœur de l'Île. C'est un peu comme s'il livrait des sushis en devenir près de chez vous.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'littoral','river'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'morning','afternoon'},
     ...
     ['tribion_carrele'] = {
        ['name'] = "tribion_carrele",
        ['label'] = "Tribion carrelé",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Ses écailles de forme losange ont longtemps été une source d'inspiration pour les carreleurs et les mosaïstes. Les couleurs et l'agencement des dessins sur ses écailles changent selon les saisons.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'south_sea','canals'},
        ['fishing_weather'] = {'SNOW','SNOWLIGHT','XMAS','BLIZZARD','FOGGY','SMOG'},
        ['fishing_period'] = {'alltime'},
     ...
     ['urgule'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Il y a probablement une bouche au milieu. Mieux vaut ne pas y mettre les doigts.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
     ...
     ['vannole_cameleon'] = {
        ['name'] = "vannole_cameleon",
        ['label'] = "Vannole caméléon",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Les membranes de ses nageoires peuvent se décrocher et se régénérer s'il est attaqué par un prédateur. Il est aussi capable de changer de couleur pour mieux se camoufler.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'SNOW','SNOWLIGHT','XMAS','BLIZZARD'},
        ['fishing_period'] = {'alltime'},
     ...
     ['william'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Oooooooooooooh ! Qui vit dans un vieux bidon dans la mer ? WILLIAM LE POISSON ! Qui est le fruit de déchets nucléaires ? WILLIAM LE POISSON !",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'big_lake'},
        ['fishing_weather'] = {'RAIN','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'evening'},
     ...
     ['xazatas'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Les pointes sur sa tête sont des parasites qui perturbent son instinct et le poussent à remonter à la surface. S'il pouvait hurler, il le ferait surement.",
        ['illustrator'] = ".Darabesque",
        ['fishing_area'] = {'north_sea'},
        ['fishing_weather'] = {'RAIN','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'alltime'},
     ...
     ['silverfish'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le SilverFish est un petit poisson argenté aux gros yeux jaunes globuleux. Son corps brillant scintille sous l'eau, ajoutant une touche d'éclat à l'écosystème marin. Malgré sa petite taille, il se déplace gracieusement et ses yeux lui confèrent une excellente vision pour la chasse. C'est une petite merveille argentée qui égaye les fonds marins. La nuit, le SilverFish se cache par peur d'être repéré par les prédateurs. Sa couleur argentée peut attirer l'attention en reflétant la lumière de la lune, ce qui le rend vulnérable. Il préfère rester discret pour éviter de devenir une proie facile.",
        ['illustrator'] = ".L'Atelier d'Adrien",
        ['fishing_area'] = {'littoral','north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'morning','afternoon'},
     ...
     ['l_aubergine_marine'] = {
        ['name'] = "l_aubergine_marine",
        ['label'] = "L'Aubergine Marine",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "L'Aubergine Marine est une créature fascinante des profondeurs océaniques. Avec sa large bouche, il ressemble à une vache marine qui broute le sol marin, se nourrissant des riches nutriments qu'il trouve sous la mer. Ses yeux jaunes lui offrent une vision exceptionnelle dans les abysses, l'aidant à repérer les zones riches en nourriture. Ce concombre de mer a un trait unique : lorsqu'il est consommé à forte dose, ses composants chimiques peuvent provoquer des hallucinations légères chez ceux qui le consomment. Cette particularité en fait une curiosité dans le monde marin, et certaines cultures côtières l'utilisent parfois à des fins rituelles ou médicinales. L'Aubergine Marine incarne la merveilleuse diversité de la vie sous-marine, avec son comportement de brouteur paisible et ses propriétés intrigantes. Il est à la fois une source de fascination pour les chercheurs marins et une légende mystique pour ceux qui croisent son chemin.",
        ['illustrator'] = ".L'Atelier d'Adrien",
        ['fishing_area'] = {'littoral','canals'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'morning','afternoon'},
     ...
     ['le_poisson_prismatique'] = {
        ['name'] = "le_poisson_prismatique",
        ['label'] = "Le Poisson Prismatique",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le Poisson Prismatique est une créature marine exceptionnelle, une véritable œuvre d'art vivante des profondeurs océaniques. Sa couleur violette profonde se marie harmonieusement avec ses motifs géométriques, qui rappellent les facettes d'un prisme. Ces formes prismatiques se superposent sur son corps, créant un camouflage visuel stupéfiant. Ce poisson a évolué pour maîtriser l'art du camouflage, en utilisant les propriétés optiques des formes géométriques pour se fondre dans son environnement sous-marin. Il est capable de réfléchir la lumière de manière à tromper les prédateurs et à se camoufler parmi les reflets chatoyants de l'eau. Cette adaptation ingénieuse lui permet d'échapper aux regards affamés et de se faufiler parmi les autres habitants de l'océan en toute discrétion. Le Poisson Prismatique incarne la splendeur de la biodiversité marine et la capacité de la nature à créer des merveilles de l'adaptation pour survivre dans les abysses mystérieux de l'océan. Son apparence extraordinaire le distingue comme l'une des créatures les plus fascinantes des profondeurs marines, une véritable œuvre d'art de la nature.",
        ['illustrator'] = ".L'Atelier d'Adrien",
        ['fishing_area'] = {'south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY','RAIN','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'morning','afternoon'},
        ['fishman_status'] = 'alcool',
        ['min_weight'] = 800,
        ['max_weight'] = 1200,
     ...
     ['le_nageoires_d_azur'] = {
        ['name'] = "le_nageoires_d_azur",
        ['label'] = "Le Nageoires d'Azur",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le Nageoires d'Azur\" est un majestueux poisson des eaux douces qui se distingue par sa couleur bleue éclatante, évoquant la profondeur des océans. Son corps élégant est fin et allongé, lui permettant de naviguer avec une agilité remarquable dans les courants sinueux des rivières et des grands lacs. Ce poisson tire son nom de ses nageoires remarquables, qui sont sa véritable fierté. Les nageoires dorsales et ventrales du Nageoires d'Azur sont particulièrement imposantes, avec des nuances de bleu allant du turquoise étincelant au cobalt profond. Ces nageoires jouent un rôle essentiel dans sa capacité à se déplacer gracieusement dans les eaux douces, le faisant paraître comme un danseur aquatique. Lorsqu'il évolue sous la lumière du soleil, les reflets chatoyants des nageoires créent un spectacle visuel éblouissant, faisant du Nageoires d'Azur une véritable merveille aquatique. Il est considéré comme une icône des environnements d'eau douce, symbole de la beauté et de la grâce de la vie aquatique. Son apparition est toujours un moment de joie pour les observateurs de la nature le long des rivières et des lacs où il réside. Le Nageoires d'Azur\" possède non seulement une beauté spectaculaire, mais aussi une force remarquable qui en fait une créature particulièrement difficile à attraper. Malgré sa silhouette élégante, ses muscles puissants lui permettent de résister vigoureusement aux tentatives de capture. Lorsqu'il est confronté à un pêcheur ou à un prédateur, il déploie sa force avec une détermination impressionnante, utilisant ses nageoires pour résister aux pressions et aux courants. C'est cette combinaison de beauté et de force qui confère au Nageoires d'Azur une aura de respect dans son habitat aquatique. Il incarne l'équilibre entre la grâce et la puissance, et sa réputation de poisson insaisissable en fait une légende parmi les pêcheurs et les amateurs de nature qui cherchent à l'observer dans son milieu naturel.",
        ['illustrator'] = ".L'Atelier d'Adrien",
        ['fishing_area'] = {'big_lake','river'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
     ...
     ['la_petite_gemme_marine'] = {
        ['name'] = "la_petite_gemme_marine",
        ['label'] = "La Petite Gemme Marine",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "La Petite Gemme Marine est une créature aussi intrigante qu'énigmatique des profondeurs océaniques. Ce tout petit calamar d'un vert émeraude bleuté mesure entre 5 et 8 cm de longueur. Malgré sa taille minuscule, il ressemble à une pierre précieuse vivante. Son corps délicat est orné de motifs en forme de constellations, qui évoquent des étoiles étincelantes sur une nuit d'été. Sa petite taille ne laisse pas présager les secrets qu'il renferme. Mais attention, car La Petite Gemme Marine détient un pouvoir mystérieux et potentiellement dangereux. Les tentacules de ce calamar sécrètent une substance chimique toxique qui, si elle est consommée en excès, peut avoir des conséquences néfastes. Cependant, cette créature fascinante a un autre tour dans son sac. La substance sécrétée par La Petite Gemme Marine est également incroyablement addictive, suscitant une fascination irrésistible chez ceux qui la découvrent. Une fois que l'on a goûté à son enchantement, il est difficile de résister à l'attrait mystique de cette petite gemme vivante des profondeurs. Ainsi, La Petite Gemme Marine incarne la beauté et la complexité de la nature marine, nous rappelant que même les créatures les plus petites et les plus discrètes peuvent cacher des secrets étonnants, à la fois séduisants et potentiellement périlleux pour ceux qui osent s'aventurer dans son monde.",
        ['illustrator'] = ".L'Atelier d'Adrien",
        ['fishing_area'] = {'littoral','north_sea','south_sea'},
        ['fishing_weather'] = {'FOGGY','SMOG','RAIN','OVERCAST','CLOUDS','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'night','evening'},
        ['fishman_status'] = 'drug',
        ['min_weight'] = 20,
        ['max_weight'] = 100,
     ...
     ['hotfeather'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le Hotfeather tire son nom du phoenix, dû à sa ressemblance et sa capacité à très vite récupérer de blessure. Malgré sa résistance physique il a une santé fragile et est très sensible à la pollution des eaux. Ses grandes nageoires lui permettent d'atteindre une vitesse supérieure à la plupart des prédateurs aquatique.",
        ['illustrator'] = ".Crash",
        ['fishing_area'] = {'north_sea','south_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'evening'},
     ...
     ['grab'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Le grab et un crabe possèdent des pinces dorsales lui permettant de transporter des objets sûrs de très longues distancent pesant 30 fois plus que lui, il s'en sert aussi pour se couvrir des pieuvres et autres prédateurs, il est très robuste et solitaire, il lui arrive donc régulièrement de croiser la pince avec d'autre crabes, à moins de tomber sur un congénère plus gros, il est invaincue face aux autres espèces de crabes",
        ['illustrator'] = ".Crash",
        ['fishing_area'] = {'littoral'},
        ['fishing_weather'] = {'FOGGY','SMOG'},
        ['fishing_period'] = {'night','morning'},
     ...
     ['tardaud'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Ce poisson se plaît dans les eaux polluées, il se couvre de déchets toxiques afin de repousser ses prédateurs, il peut ramper hors de l'eau quand la marée est basse pour changer de secteur, il se nourrit de détritus ce qui lui vaut le surnom de mouche à mer.",
        ['illustrator'] = ".Crash",
        ['fishing_area'] = {'littoral','canals'},
        ['fishing_weather'] = {'RAIN','OVERCAST','CLOUDS'},
        ['fishing_period'] = {'night','evening'},
     ...
     ['anemone_printaniere'] = {
        ['name'] = "anemone_printaniere",
        ['label'] = "Anémone printanière",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Cette anémone paraît à première vue tout ce qu'il y a de plus banal, et pourtant elle est aussi toxique pour l'homme qu'une amanite printanière, d'où le nom qui lui a été donné afin de décourager les curieux voulant la manipuler. Manque de chance les gens ne comprenant pas la référence la prennent pour une plante de saison, bon nombre d'intoxiqué finissent aux urgences du LSMC, comme quoi une encyclopédie n'est pas là juste pour les images.",
        ['illustrator'] = ".Crash",
        ['fishing_area'] = {'littoral','north_sea'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'morning','afternoon'},
     ...
     ['amalgatine'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "Cet amalgame de coraux exotiques fait partie des rares espèces d'eau douce encore présente à Los Santos, dû à sa forte teneur en alcool pour des raisons que le gouvernement ne souhaite pas communiquer, les poissons alentour finissent dans un été d'ébriété qui ferait plonger le BCSO afin de les amender.",
        ['illustrator'] = ".Crash",
        ['fishing_area'] = {'big_lake','little_lake'},
        ['fishing_weather'] = {'CLEAR','CLEARING','EXTRASUNNY'},
        ['fishing_period'] = {'night'},
     ...
     ['ourou_beerus'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'classic',
        ['description'] = "On raconte que ce poisson est un descendant du légendaire Jörmungandr qui était considérer comme le serpent qui entourait midgard. Il permettait selon la légende que les mers ne déborde pas. Aujourd'hui tout ce qu'il entoure c'est peux être ta jambes mais en lui donnant un peu d'alcool il te lachera sans soucis.",
        ['illustrator'] = ".Beerrrr",
        ['fishing_area'] = {'littoral','big_lake'},
        ['fishing_weather'] = {'RAIN','THUNDER','BLIZZARD'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_horrostine'] = {
        ...
        ['description'] = "Si elle se sent menacée, l'horrostine est capable d'extérioriser ses vaisseaux sanguins par sa bouche à une vitesse telle que l'onde de choc qui se propage dans l'eau peut éclater un pare brise.",
        ['illustrator'] = '.Darabesque',
        ['fishing_area'] = {'river', 'little_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 36,          -- poids minimal en grammes
        ['max_weight'] = 50,         -- poids maxmimal en grammes
        ['min_length'] = 12,           -- taille minimale en cm
        ['max_length'] = 15,          -- taille minimale en cm
        ['sozedex_id'] = 1,
    ...
    ['halloween_cycrabe'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Presque aveugle, le Cycrabe a une ouïe et une perception des vibrations assez fine pour ne jamais perdre ses proies. Lorsqu'il se met en chasse, il ne s'arrête pas avant d'être repus.",
        ['illustrator'] = '.Darabesque',
        ['fishing_area'] = {'littoral', 'south_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 509,          -- poids minimal en grammes
        ['max_weight'] = 666,         -- poids maxmimal en grammes
        ['min_length'] = 21,           -- taille minimale en cm
        ['max_length'] = 29,          -- taille minimale en cm
        ['sozedex_id'] = 2,
        ['price'] = 87
    ...
    ['halloween_neostraceae_horribilis'] = {
        ...
        ['label'] = "Neostraceae horribilis",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Si on met son oreille près de ce coquillage peu ordinaire, ce n'est pas la mer que l'on entend, mais des cris lointains et difformes. Il vaut mieux éviter d'en approcher son visage trop longtemps aussi... Il pourrait mordre.",
        ['illustrator'] = '.Darabesque',
        ['fishing_area'] = {'north_sea', 'big_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 2300,          -- poids minimal en grammes
        ['max_weight'] = 4500,         -- poids maxmimal en grammes
    ...
    ['halloween_pagure_rouge'] = {
        ...
        ['illustrator'] = '.Darabesque',
        ['fishing_area'] = {'canals', 'big_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 2999,          -- poids minimal en grammes
        ['max_weight'] = 3333,         -- poids maxmimal en grammes
    ...
    ['halloween_squalus_infernalis'] = {
        ...
        ['label'] = "Squalus Infernalis",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Ce requin des enfers surgit des abysses, ses nageoires diaboliques frémissant d'une lueur écarlate, tandis que ses dents acérées ressemblent à des lames ensanglantées. Ses yeux injectés de haine semblent capables de percer les âmes et hanter les rêves les plus innocents.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'north_sea', 'south_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'alcool',   -- drug, alcool, clean
        ['min_weight'] = 680,          -- poids minimal en grammes
        ['max_weight'] = 2000,         -- poids maxmimal en grammes
        ['min_length'] = 50,           -- taille minimale en cm
        ['max_length'] = 300,          -- taille minimale en cm
        ['sozedex_id'] = 6,
    ...
    ['halloween_fantocean'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Fantocéan, éthéré et glacial, hante les profondeurs, ses écailles translucides révélant une essence fantomatique qui se déplace silencieusement dans l'obscurité abyssale, attirant les âmes errantes vers un destin insondable.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'north_sea', 'south_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_langue_de_satan'] = {
        ...
        ['label'] = "Langue de Satan",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le crustacé semblable à une crevette est en réalité la langue d'un animal plus gros et carapaces. Ce leurre lui permet d'attirer des proies qu'il dévore ensuite en les broyant.",
        ['illustrator'] = '.Darabesque',
        ['fishing_area'] = {'little_lake', 'canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 366,          -- poids minimal en grammes
        ['max_weight'] = 600,         -- poids maxmimal en grammes
        ['min_length'] = 10,           -- taille minimale en cm
    ...
    ['halloween_toxzoguille'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Petite anguille vicieuse qui se fera un malin plaisir de dissoudre votre hameçon. Mais si vous arrivez à la pêcher gard à vos mains qui pourraient devenir qu'un tas d'os sous sa toxine qui recouvre son corps.",
        ['illustrator'] = '.Ariisnoe',
        ['fishing_area'] = {'little_lake', 'river'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'drug',   -- drug, alcool, clean
    ...
    ['halloween_melusgnark'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Petite méduse mutante ayant mangé trop de citrouille. Si vous entendez un petit rire aiguë étouffé faite attention à vos pieds et ne les laissez pas dans l'eau, elle pourrait s’agripper à vous pour vous les manger.",
        ['illustrator'] = '.Ariisnoe',
        ['fishing_area'] = {'littoral', 'south_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'drug',   -- drug, alcool, clean
        ['min_weight'] = 192,          -- poids minimal en grammes
        ['max_weight'] = 627,         -- poids maxmimal en grammes
        ['min_length'] = 13,           -- taille minimale en cm
        ['max_length'] = 48,          -- taille minimale en cm
        ['sozedex_id'] = 10,
        ['price'] = 86
    ...
    ['halloween_krakenos'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Krakenos, créature issue des abysses, est une pieuvre squelettique d'une inquiétante beauté. Ses tentacules striés de noir et blanc évoquent les écrits de Lovecraft, et sa malice légendaire est le cauchemar des marins.",
        ['illustrator'] = '.Sniteur',
        ['fishing_area'] = {'river', 'canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_chyrobissus'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Chirobyssus est une créature diabolique des abysses, un poisson noir et blanc aux allures démoniaques. Son corps sinistre est parcouru de motifs démoniaques. Surnommé \"l'aile de la mort tournoyante,\" il est l'incarnation de la malveillance et du chaos sous-marin.",
        ['illustrator'] = '.Sniteur',
        ['fishing_area'] = {'north_sea', 'big_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_necrocampe'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Nécrocampe est comme l'hippocampe des enfers, une créature qui hante les cauchemars. Cette sinistre apparition évoque une équitation macabre dans les profondeurs, une créature des ténèbres à la beauté dérangeante.",
        ['illustrator'] = '.Sniteur',
        ['fishing_area'] = {'north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_piranheon'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Piranhéon est un piranha fantomatique, une créature démoniaque venue des enfers pour semer la terreur dans les eaux sombres. Son visage en perpétuelle déformation est un cri du cosmos annonçant l'apocalypse. La transparence de son être renforce son aura maléfique.",
        ['illustrator'] = '.Sniteur',
        ['fishing_area'] = {'big_lake','canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'drug',   -- drug, alcool, clean
        ['min_weight'] = 300,          -- poids minimal en grammes
    ...
    ['halloween_crustademon'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Crustadémon est une créature démoniaque qui ressemble à un crustacé issu de l'enfer. Sa coque est ornée d'une tête de mort. Cette créature marine, avec sa coquille en forme de maison sinistre, possède des épines effilées qui rappellent les marées du chaos. Sa présence évoque des rituels sataniques dans les profondeurs de l'océan.",
        ['illustrator'] = '.Sniteur',
        ['fishing_area'] = {'big_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_octohydra_nocturne'] = {
        ...
        ['label'] = "Octohydra Nocturne",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "L'Octohydra Nocturne est une pieuvre démoniaque d'un noir abyssal, ornée de cornes menaçantes. Sa réputation de créature maléfique est méritée, car elle est la personnification du danger dans les profondeurs. Ses multiples tentacules, semblables à ceux de l'hydre, en font un prédateur redoutable. Elle incarne le côté le plus sinistre et satanique des océans.",
        ['illustrator'] = '.Sniteur',
        ['fishing_area'] = {'big_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_abyssodemon'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "L'Abyssodémon, entité démoniaque des abysses, se profile dans les ténèbres comme une créature venue tout droit des enfers, ses yeux incandescents perçant les âmes des malheureux qui croisent son chemin, prêt à déchiqueter tout intrus avec ses dents acérées. Son apparence cauchemardesque, mi-poisson, mi-démon, évoque la terreur ultime, transformant les mers profondes en un royaume de l'horreur dont nul ne ressort indemne.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'littoral','north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_crustamortis'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Crustamortis, une créature lacustre d'outre-tombe, émerge des profondeurs des lacs, sa carapace noire couverte de scarifications sinistres, et ses pinces acérées gouttant d'une substance lugubre. Ses yeux luisent d'une lueur démoniaque, tandis qu'un gémissement funeste s'échappe de ses pinces mortelles, transformant les paisibles lacs en des nids d'horreur insondable.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'big_lake','little_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_oculymphe'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "L'Oculymphe, une créature aquatique ressemblant à une crevette déformée, se distingue par un œil unique et sinistre, une pupille abyssale capable de scruter les profondeurs de l'âme pour en aspirer la lumière. Elle erre dans les rivières, cherchant à capturer les âmes des infortunés et à les plonger dans un abîme de terreur éternelle.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'river'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_necromurene'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "La Nécromurène, créature des canaux, est une abomination squelettique, sa peau en lambeaux révélant des mâchoires tranchantes et des yeux vides qui émettent une lueur malsaine. Elle rôde dans les ténèbres des canaux, émettant un sinistre hurlement silencieux qui glace le sang des malheureux qui croisent son chemin, prête à dévorer les âmes imprudentes et à les plonger dans un abîme de terreur éternelle.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 372,          -- poids minimal en grammes
        ['max_weight'] = 1357,         -- poids maxmimal en grammes
        ['min_length'] = 42,           -- taille minimale en cm
    ...
    ['halloween_marecaille'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Marécaille est une créature abjecte, ses écailles écumeuses dégoulinant d'un venin visqueux, tandis que sa gueule béante exhale une puanteur putride, transformant les marécages déjà nauséabonds en un véritable cloaque d'horreur. Ses crocs empoisonnés déchirent les eaux, laissant une traînée de maladie et de mort, chaque ondulation de son corps décomposé transformant la nature en un marécage de déliquescence et de décrépitude.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 87,          -- poids minimal en grammes
        ['max_weight'] = 2374,         -- poids maxmimal en grammes
    ...
    ['halloween_necrotriton'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Nécrotriton est une créature amphibie sinistre, sa peau décomposée suintant un poison mortel, ses yeux luisants évoquant les abîmes de l'au-delà. Il hante les rivages marins maudits, ses ululements nocturnes perçant l'obscurité, tandis que son corps ressuscité émerge des mers, corrompant les âmes et projetant une ombre aquatique funeste sur tout ce qui croise son sinistre chemin.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'littoral'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'drug',   -- drug, alcool, clean
        ['min_weight'] = 352,          -- poids minimal en grammes
        ['max_weight'] = 1579,         -- poids maxmimal en grammes
    ...
    ['halloween_zombiecetus'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Zombicetus, autrefois symbole de grâce et d'amitié dans les eaux, est désormais une aberration sinistre, ses bonds élégants se transformant en attaques féroces, déchirant la mer de sa nouvelle cruauté. Les échos lointains de son cri jadis mélodieux résonnent maintenant comme un avertissement lugubre pour quiconque ose s'aventurer dans les profondeurs où il règne en maître déchu. \"Il fait flipper, Flipper.\"",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'north_sea','south_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'drug',   -- drug, alcool, clean
        ['min_weight'] = 3326,          -- poids minimal en grammes
        ['max_weight'] = 4914,         -- poids maxmimal en grammes
    ...
    ['halloween_krueger_des_abyss'] = {
        ...
        ['label'] = "Krueger des Abysses",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Krueger des Abysses est une créature marine cauchemardesque, arborant des nageoires déchiquetées telles des griffes, tandis que son corps est marqué de cicatrices monstrueuses. Il erre dans les profondeurs des océans, traquant silencieusement ses proies, prêt à réveiller vos pires terreurs aquatiques.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'littoral'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 154,          -- poids minimal en grammes
        ['max_weight'] = 3421,         -- poids maxmimal en grammes
        ['min_length'] = 27,           -- taille minimale en cm
    ...
    ['halloween_larve_de_xenocrevisse'] = {
        ...
        ['label'] = "Larve de Xénocrevisse",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "La larve de la Xénocrevisse émerge de son oeuf dans une scène cauchemardesque, sa silhouette sombre et translucide enveloppée dans une carapace gélatineuse. Ses mandibules acérées s'étirent pour percer la chair de ses proies. Elle grandit rapidement en se nourrissant de la peur et de l'angoisse de ses victimes, en plus de leurs chairs.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'littoral','canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'alcool',   -- drug, alcool, clean
        ['min_weight'] = 18,          -- poids minimal en grammes
        ['max_weight'] = 234,         -- poids maxmimal en grammes
        ['min_length'] = 4,           -- taille minimale en cm
    ...
    ['halloween_xenocrevisse'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "La Xénocrevisse se distingue par son corps élancé et agile, une redoutable machine de mort équipée de pattes acérées pour la chasse. Sa tête effrayante, avec ses mâchoires rétractables, inspire l'effroi. Elle chasse en toute discrétion, traquant ses proies avec une cruauté implacable et une détermination sans faille à semer la terreur. Dès qu'elle repère sa proie, l'horreur s'ensuit, car la Xénocrevisse laisse derrière elle un sillage de destruction et de désolation.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'littoral','canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'drug',   -- drug, alcool, clean
        ['min_weight'] = 311,          -- poids minimal en grammes
        ['max_weight'] = 2418,         -- poids maxmimal en grammes
    ...
    ['halloween_corail_necrosclere'] = {
        ...
        ['label'] = "Corail Nécrosclère",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Corail Nécrosclère est une aberration sous-marine d'une beauté sinistre, formée à partir de cadavres marins et de débris macabres. Ses branches coralliennes, telles des bras squelettiques, s'étirent dans les abysses ensorcelés, exhalant des poisons marins mortels et créant un charme fatal. Ce récif maudit transforme les cadavres en une macabre symphonie de désolation sous-marine, où la vie et la mort s'entrelacent dans une étreinte funeste.",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'south_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'alcool',   -- drug, alcool, clean
        ['min_weight'] = 146,          -- poids minimal en grammes
        ['max_weight'] = 2437,         -- poids maxmimal en grammes
    ...
    ['halloween_mycrable'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Mutation entre une araignée et un crabe albinos, si ses pinces ont été remplacées par des mandibules empoisonnées et fines comme des aiguilles, sa carapace et ses nombreux yeux n'en font pas moins un animal des plus dangereux, arachnophobe s'abstenir..",
        ['illustrator'] = '.Aardocan',
        ['fishing_area'] = {'north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 28,          -- poids minimal en grammes
        ['max_weight'] = 54,         -- poids maxmimal en grammes
        ['min_length'] = 12,           -- taille minimale en cm
    ...
    ['halloween_poisson_clown_clown'] = {
        ...
        ['label'] = "Poisson clown clown",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "POUET POUET ! C'est un poti blagueur ! Un poti blagueur qui fait quand même vachement peur... ",
        ['illustrator'] = '.Pastouke',
        ['fishing_area'] = {'littoral','north_sea','south_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_bleurk'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Bleurk est une masse visqueuse et translucide qui prospère dans les canalisations sombres et sales. Il se déplace en glissant comme une méduse. Son corps dégage une lueur verdâtre malsaine, et il est souvent associé à des rumeurs d'activités étranges dans les égouts. Les légendes urbaines racontent que le Blop des égouts peut engloutir des gens.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_nagabyssale'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "La Nagabyssale est une créature maléfique issue des profondeurs océaniques. Son corps serpentiforme est recouvert d'écailles sombres et sinistres, avec des yeux écarquillés luisant d'une lueur malsaine. Ses crocs acérés sont prêts à déchirer toute proie qui s'approche. Elle possède des tentacules ondulantes qui captent les âmes perdues, les attirant vers sa gueule béante.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'north_sea','south_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_candy_jelly_fish'] = {
        ...
        ['label'] = "Candy Jelly-fish",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Elle est mignonne ? Tu as envie de manger ses petites boulles en forme de bonbon ? ET bah elle sont toxiques ! Manges en une et tu meurs dans les 10 minutes qui suivent ! Mais bon elle est toute mimi UwU !",
        ['illustrator'] = '.Pastouke',
        ['fishing_area'] = {'big_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_zoctulus'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Attention cet animal est plus rapide qu'il n'y paraît et à partir du moment où ses ventouses sont collées à vous, vous pouvez dire adieu à votre cervelle qui sera aspirée grâce à ses mandibules buccales",
        ['illustrator'] = '.Ariisnoe',
        ['fishing_area'] = {'littoral','north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'drug',   -- drug, alcool, clean
        ['min_weight'] = 999,          -- poids minimal en grammes
        ['max_weight'] = 1666,         -- poids maxmimal en grammes
    ...
    ['halloween_barracroutta'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Requin zombifié à la chair putride. Une partie de ses os sont visibles et il est aveugle ses globes oculaires s'étant décomposés. Mais il se fera un plaisir de vous avoir comme dîner, attention à ne pas se couper sur la rocher ou se baigner trop loin des bords de plage.",
        ['illustrator'] = '.Ariisnoe',
        ['fishing_area'] = {'south_sea','north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 2580,          -- poids minimal en grammes
        ['max_weight'] = 4567,         -- poids maxmimal en grammes
    ...
    ['halloween_batteraie'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Poom Boom Tchak ! Une espèce de raie que sort seulement la nuit, elle est aveugle aussi, elle se repère grâce a un sonar similaire au dauphin, étonnamment il fait le bruit d'une batterie !",
        ['illustrator'] = '.Pastouke',
        ['fishing_area'] = {'north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 2000,          -- poids minimal en grammes
        ['max_weight'] = 3000,         -- poids maxmimal en grammes
    ...
    ['halloween_nagazkill'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Ne vous détrompez pas on est loin de la licorne avec son arc-en-ciel et ses papillons, celui-ce se fera un malin plaisir à vous embrocher et vous mordre à la moindre occasion.",
        ['illustrator'] = '.Ariisnoe',
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 835,          -- poids minimal en grammes
        ['max_weight'] = 1749,         -- poids maxmimal en grammes
    ...
    ['halloween_cranaraignee'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Une araignée de mer qui utilise le crane de petits animales mort dans les rivières ou au bord des lacs comme carapace.",
        ['illustrator'] = '.Pastouke',
        ['fishing_area'] = {'big_lake','river'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_crapamanite'] = {
        ...
        ['label'] = "Crapamanite avaleur de mouches",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Ce crapaud peut facilement se fondre dans un environnement automnal et attend ses proies patiemment. Ne vous fiez pas à sa jolie couleur rouge et au parfum sucré qu'il dégage, ce crapaud est utilisé dans la création de puissantes potions.",
        ['illustrator'] = '.Pastouke',
        ['fishing_area'] = {'little_lake','river'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'alcool',   -- drug, alcool, clean
        ['min_weight'] = 30,          -- poids minimal en grammes
        ['max_weight'] = 50,         -- poids maxmimal en grammes
        ['min_length'] = 300,           -- taille minimale en cm
    ...
    ['halloween_crapeau_or'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Faites bien attention si vous l'attrapez à mains nues, ses cloques dégagent un puissant poison. Il se peut aussi qu'il tente de vous sauter dessus pour vous embrasser. Qui sait alors ce qui pourrait arriver...",
        ['illustrator'] = '.Pastouke',
        ['fishing_area'] = {'little_lake','big_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_anibaltortle'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Ce mutant aux yeux rouges n'est pas inoffensif, ses yeux rouges ne discerne que les bijoux. Gard à vos mains, poignets et cou, une morsure ou un coup de griffe peut vite arriver pour qu'il récupère \"son  précieux\" trésor. Si vous entendez ces mot fuyiez!",
        ['illustrator'] = '.Ariisnoe',
        ['fishing_area'] = {'little_lake','littoral'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'drug',   -- drug, alcool, clean
        ['min_weight'] = 1627,          -- poids minimal en grammes
        ['max_weight'] = 3916,         -- poids maxmimal en grammes
    ...
    ['halloween_maglimace'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "La maglimace est une créature aquatique adaptée aux eaux chaudes. Elle a une apparence unique, avec une peau brillante et résistante aux températures élevées. Ses couleurs vont du rouge vif à l'orange flamboyant, lui permettant de se fondre dans les environnements volcaniques. Elle se déplace avec grâce, utilisant des appendices natatoires pour naviguer dans les courants de lave et des branchies spéciales pour extraire des nutriments des minéraux fondus.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'little_lake','big_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 23,          -- poids minimal en grammes
        ['max_weight'] = 86,         -- poids maxmimal en grammes
        ['min_length'] = 12,           -- taille minimale en cm
        ['max_length'] = 36,          -- taille minimale en cm
        ['sozedex_id'] = 42,
        ['price'] = 79
    ...
    ['halloween_zombaleine'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "La zombaleine est une créature mythique dotée d'une immunité à la mort conventionnelle. Son corps est constamment en décomposition, mais tant qu'une partie de son organisme subsiste, elle ne peut pas mourir. Les baleines zombies errent dans les océans avec des parties de leur corps en lambeaux, dégageant une odeur putride. Elles évoquent une immuabilité macabre, symboles de la persistance contre vents et marées.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'south_sea','north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'drug',   -- drug, alcool, clean
        ['min_weight'] = 1230,          -- poids minimal en grammes
        ['max_weight'] = 4900,         -- poids maxmimal en grammes
    ...
    ['halloween_mawgma'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "La Mawgma est une créature aquatique d'apparence rocheuse et volcanique. Son corps est constitué de roche en fusion, et sa gueule béante est un abîme de lave brûlante. Elle émerge des profondeurs des océans, projetant des jets de lave en fusion dans les airs. Sa présence incarne la fusion élémentaire entre terre et eau, créant une force redoutable de destruction dans les mers tumultueuses.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'south_sea','north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_cravone'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "La Cravone est une créature étrange, une crevette arborant une tête de dragon aux yeux vides et à la peau en décomposition. Sa chair dégage une odeur putride. Elle émerge des profondeurs marines, un symbole de transformation morbide, associant la beauté et la laideur dans un seul être, créant un mystère envoûtant dans les fonds marins.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'littoral','canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 123,          -- poids minimal en grammes
        ['max_weight'] = 235,         -- poids maxmimal en grammes
        ['min_length'] = 23,           -- taille minimale en cm
    ...
    ['halloween_fusionotik'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Fusionotik est une créature unique, ressemblant à un crapaud ordinaire mais avec une poche de magma incandescent sur son ventre. Cette poche émet une lueur ardente et projette des étincelles. Il éjecte des petits jets sur ses proies. Symbole de l'énergie brute. Ce crapaud est une énigme, un être à la fois vulnérable et dangereux, évoquant un équilibre délicat entre la vie et la destruction.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'river','little_lake'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 20,          -- poids minimal en grammes
        ['max_weight'] = 130,         -- poids maxmimal en grammes
        ['min_length'] = 9,           -- taille minimale en cm
    ...
    ['halloween_zombescargot'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Un petit escargot qui utilise ces petit bras pour glisser sur le sol ! Bon il mange les cerveaux de ces victime qu'il tue avec ça bave acide mais bon ça c'est un détail...",
        ['illustrator'] = '.Pastouke',
        ['fishing_area'] = {'canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_machoire_hades'] = {
        ...
        ['label'] = "Machoire d'Hadès",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "La machoire d'Hadès est probablement la dernière chose que vous verrez dans votre existence, un crabe colossal qui garde la porte sous-marine menant aux Enfers. Son exosquelette est d'obsidienne, ses pinces acérées prêtes à empêcher tout intrus d'entrer. Sa présence évoque la frontière entre les mondes, une sentinelle sinistre veillant sur le royaume des morts dans les abysses marins.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'south_sea','north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 4600,          -- poids minimal en grammes
        ['max_weight'] = 5000,         -- poids maxmimal en grammes
        ['min_length'] = 320,           -- taille minimale en cm
    ...
    ['halloween_millipop'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "La Millipop est une créature marine redoutable. Son corps massif est orné de tentacules multiples, chacun chargé de venin toxique. Ces appendices serpentent et saisissent leur proie avec une agilité mortelle. Une rencontre avec cette pieuvre peut être fatale, car ses tentacules injectent un poison mortel paralysant les victimes avant de les dévorer. ",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'littoral','canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 862,          -- poids minimal en grammes
        ['max_weight'] = 2456,         -- poids maxmimal en grammes
    ...
    ['halloween_necrojiko'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Necrojiko a un corps dépourvu de chair, exposant des os et une peau translucide. Il erre dans les eaux sombres, se nourrissant de la chair d'autres poissons. Sa présence évoque une horreur maritime, un spectre affamé des profondeurs qui se délecte de la vie des autres créatures marines. Un cauchemar aquatique.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'littoral','north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 230,          -- poids minimal en grammes
        ['max_weight'] = 650,         -- poids maxmimal en grammes
        ['min_length'] = 60,           -- taille minimale en cm
        ['max_length'] = 130,          -- taille minimale en cm
        ['sozedex_id'] = 52,
        ['price'] = 54
    ...
    ['halloween_redhug'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "La Redhug est une créature mythique des enfers, ses tentacules ardentes brillent d'un rouge écarlate. Ses yeux lancent des éclairs maléfiques et ses ventouses dégagent un feu brûlant. Elle est le gardien des abysses infernaux, symbole de la puissance démoniaque des océans.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'south_sea','north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 1200,          -- poids minimal en grammes
        ['max_weight'] = 2600,         -- poids maxmimal en grammes
        ['min_length'] = 230,           -- taille minimale en cm
        ['max_length'] = 350,          -- taille minimale en cm
        ['sozedex_id'] = 53,
        ['price'] = 71
    ...
    ['halloween_damned_stinger'] = {
        ...
        ['label'] = "Damned Stinger",
        ['useable'] = false,
        ['weight'] = 200,
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Damned stinger est une créature des profondeurs, sa carcasse décharnée évoque une âme tourmentée. Ses yeux brûlent d'une lueur hantée, et ses nageoire en appendices squelettiques. On dit qu'il est condamné à errer dans les abysses, portant une malédiction ancestrale qui engloutit quiconque ose le croiser. Les marins le craignent, le considérant comme un présage sinistre de la mer.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'south_sea','north_sea'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
    ...
    ['halloween_swimming_dead'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le swiming dead est une créature morte-vivante des eaux, pourrie et décomposée, évoluant avec une démarche macabre. Sa peau est pâle et déchirée, ses yeux sont vides, émettant une lueur fantomatique. Des lambeaux de chair en décomposition pendent de son corps. Il hante les marais et les eaux stagnantes, se nourrissant de cadavres et d'algues putrides, créant une aura sinistre dans son sillage. Un être terrifiant de l'au-delà marin.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'littoral','canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 230,          -- poids minimal en grammes
        ['max_weight'] = 460,         -- poids maxmimal en grammes
        ['min_length'] = 12,           -- taille minimale en cm
        ['max_length'] = 50,          -- taille minimale en cm
        ['sozedex_id'] = 55,
        ['price'] = 71
    ...
    ['halloween_kokichonk'] = {
        ...
        ['type'] = 'fish',
        ['fish_generation'] = 'halloween',
        ['description'] = "Le Kikochonk d'homme est une coquille géante aux reflets sinistres. Son intérieur obscur cache de puissantes mandibules dentelées, prêtes à saisir quiconque s'aventure trop près. Il émet un chant séducteur pour attirer les curieux, puis les engloutit, condamnant ainsi leurs âmes à une éternité sombre. Un piège mortel des profondeurs marines.",
        ['illustrator'] = '.Crash',
        ['fishing_area'] = {'littoral','canals'},
        ['fishing_weather'] = {'allweather'},
        ['fishing_period'] = {'alltime'},
